          ...
          <div className="text-center">
            ...
            <div className="bg-white  flex items-center justify-center">
              <button
                ...
                className="group flex w-60 cursor-pointer select-none items-center justify-center rounded-md bg-[#a5bb08] hover:bg-[#87A922] px-6 py-2 text-white transition"
              >
                <a className="group flex w-full items-center justify-center rounded py-2 text-center font-bold">
                  Ajouter au panier
                </a>
                <svg
